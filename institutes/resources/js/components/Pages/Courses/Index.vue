                                    ...
                                    <div class="col-span-12 xxl:col-span-6">
                                        <div>
                                            ...
                                            >
                                                ...
                                                <option v-for="(courseType, index) in courseTypes.data" 
                                                        :key="index" 
                                                        :value="courseType.id">{{ JSON.parse(courseType.label) }}</option>
                                            </TailSelect>
                                        </div>
                                    </div>
                                    <div class="col-span-12 xxl:col-span-6">
    ...
    setup(){
        ...
        const rules = computed(() => {
            return {
                ...
                course_type: {
                    required: helpers.withMessage('Please select atleast one course type.', required),
                },
                tags: {
