<template>
    <div>
        <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
            <h2 class="text-lg font-medium mr-auto">{{ $t('Edit Subject')}}</h2>
...
export default {
    ...
    setup(props, context) {
        ...
        editMode.value = true;
        // After items are fetched, we have to get all the languages using gettters
        ...
        const fetch = async() => {
            ...
            try {
                ...
                const result = await axios.get(`/api/v1/subjects/${id}/edit`);
