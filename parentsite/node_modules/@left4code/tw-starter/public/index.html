...
<html lang="en">
  ...
  <body class="text-sm p-5">
    <div class="p-5 border-2 rounded-md">
      <div class="accordion" id="faq-accordion-1">
        <div class="accordion-item">
          <div class="accordion-header" id="faq-accordion-content-1">
            <button
        ...
        <div class="accordion-item">
          <div class="accordion-header" id="faq-accordion-content-2">
            <button
        ...
        <div class="accordion-item">
          <div class="accordion-header" id="faq-accordion-content-3">
            <button
              class="accordion-button collapsed"
              type="button"
              data-bs-toggle="collapse"
        ...
        <div class="accordion-item">
          <div class="accordion-header" id="faq-accordion-content-4">
            <button
              class="accordion-button collapsed"
              type="button"
              data-bs-toggle="collapse"
    ...
    <div class="p-5 border-2 rounded-md mt-5">
      <div class="accordion accordion-boxed" id="faq-accordion-2">
        <div class="accordion-item">
          <div class="accordion-header" id="faq-accordion-content-1">
            <button
              class="accordion-button"
    ...
    <div class="p-5 border-2 rounded-md mt-5">
      ...
      <button class="btn btn-outline-secondary w-24 inline-block mr-1 mb-2">
        Secondary
      </button>
    ...
    <div class="p-5 border-2 rounded-md mt-5">
      ...
      <button class="btn btn-success mr-1 mb-2">
        Adding
        <i
          data-loading-icon="spinning-circles"
          data-color="white"
          class="w-4 h-4 ml-2"
        ></i>
      </button>
      ...
      <button class="btn btn-danger mr-1 mb-2">
        Deleting
        <i data-loading-icon="puff" data-color="white" class="w-4 h-4 ml-2"></i>
      </button>
    </div>
    <div class="p-5 border-2 rounded-md mt-5">
    ...
    <div class="p-5 border-2 rounded-md mt-5">
      ...
      <div
        class="alert alert-secondary show flex items-center mb-2"
        role="alert"
      >
    ...
    <div class="p-5 border-2 rounded-md mt-5">
      ...
      <div
        class="alert alert-secondary alert-dismissible show flex items-center mb-2"
        role="alert"
      >
        <i data-feather="alert-octagon" class="w-6 h-6 mr-2"></i> Awesome alert
        with icon
      ...
      <div
        class="alert alert-warning alert-dismissible show flex items-center mb-2"
        role="alert"
      >
        <i data-feather="alert-circle" class="w-6 h-6 mr-2"></i> Awesome alert
        with icon
      ...
      <div
        class="alert alert-dark alert-dismissible show flex items-center mb-2"
        role="alert"
      >
        <i data-feather="alert-triangle" class="w-6 h-6 mr-2"></i> Awesome alert
        with icon
    ...
    <div class="p-5 border-2 rounded-md mt-5">
      <div
        class="alert alert-outline-primary alert-dismissible show flex items-center mb-2"
        role="alert"
      >
        <i data-feather="alert-circle" class="w-6 h-6 mr-2"></i> Awesome alert
        with icon
      ...
      <div
        class="alert alert-outline-secondary alert-dismissible show flex items-center mb-2"
        role="alert"
      >
        <i data-feather="alert-octagon" class="w-6 h-6 mr-2"></i> Awesome alert
        with icon
      ...
      <div
        class="alert alert-outline-success alert-dismissible show flex items-center mb-2"
        role="alert"
      >
        <i data-feather="alert-triangle" class="w-6 h-6 mr-2"></i> Awesome alert
        with icon
      ...
      <div
        class="alert alert-outline-dark alert-dismissible show flex items-center mb-2"
        role="alert"
      >
        <i data-feather="alert-triangle" class="w-6 h-6 mr-2"></i> Awesome alert
        with icon
    ...
    <div class="p-5 border-2 rounded-md mt-5">
      ...
      <div
        class="alert alert-secondary-soft show flex items-center mb-2"
        role="alert"
      >
        <i data-feather="alert-octagon" class="w-6 h-6 mr-2"></i> Awesome alert
        with icon
      ...
      <div
        class="alert alert-dark-soft show flex items-center mb-2"
        role="alert"
      >
        <i data-feather="alert-triangle" class="w-6 h-6 mr-2"></i> Awesome alert
        with icon
    ...
    <script src="/dist/js/starter.js"></script>
